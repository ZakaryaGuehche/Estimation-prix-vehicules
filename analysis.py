...
if r2 > 0.90:
    print(f"\nExcellent ! Le modele explique {r2*100:.1f}% de la variance.")
elif r2 > 0.80:
    print(f"\nBon modele. R2 = {r2*100:.1f}%")
else:
    print(f"\nModele a ameliorer. R2 = {r2*100:.1f}%")
